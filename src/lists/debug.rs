...
pub const STATUSES: &[Status] = &[
    ...
    Status::new (2, Change::Modifier (6, false), Trigger::OnOccupy, 2, Target::Map (ID_UNINITIALISED), false, None), // poison_2
    Status::new (3, Change::Modifier (1, false), Trigger::None, DURATION_PERMANENT, Target::Map (ID_UNINITIALISED), false, None), // terrain_cost_down_permanent
    Status::new (4, Change::Modifier (6, false), Trigger::OnOccupy, 2, Target::Map (ID_UNINITIALISED), false, Some (3)), // poison_2
    ...
    Status::new (11, Change::Modifier (2, false), Trigger::None, 1, Target::Map (ID_UNINITIALISED), false, None), // atk_up_def_down
];
...
pub const SKILLS: &[Skill] = &[
    Skill::new (0, 5, Target::This, Area::Single, 0, Activity::Timed (0, 2)),
    ...
    Skill::new (4, 8, Target::Ally, Area::Single, 0, Activity::Timed (0, 2)),
    Skill::new (5, 8, Target::Allies, Area::Radial (2), 0, Activity::Timed (0, 2)),
    Skill::new (6, 8, Target::This, Area::Single, 0, Activity::Timed (0, 2)),
];
